...
If you notice that spacing is weird between your escaped characters and your normal ones, swap the space at then end of the sequence with a tilde (\textasciitilde).\par
\end{frame}
